---
name: "通汇项目-手续清单文档批量OCR与结构化提取"
type: project-specific
project: "通汇光伏资产包手续清单整理"
created: 2026-06-11
updated: 2026-06-11
...
对通汇光伏资产包（江苏/上海/珠海，共11个项目）的手续文档进行批量OCR、LLM结构化信息提取，生成按目录结构排列的Excel手续清单。
...
- `通汇手续清单_提取结果.xlsx` — 最终Excel，按目录排序，LLM提取元数据
...
- **珠海一期二期排序问题**：目录名没有数字前缀时（"高景一期"/"高景二期"），需要用项目名文本排序而非编号
...
- **目录前缀残留**：上海资产包的文件名在Excel中可能带"8接入系统的批复/"前缀，需要用`os.path.basename`清洗

## 关联

- 关联项目：通汇光伏资产包手续清单
- 关联流程：[MinerU合同PDF批量OCR](project-specific/MinerU合同PDF批量OCR.md)
